...
#
apr_builddir=/opt/bitnami/common/build-1
apr_builders=/opt/bitnami/common/build-1
top_builddir=/opt/bitnami/common/build-1
...
CPPFLAGS=-I/bitnami/lampstack-linux-x64/output/sqlite/include -I/opt/bitnami/common/include -I/opt/bitnami/common/include/sasl -I/opt/bitnami/common/include
LDFLAGS=-L/bitnami/lampstack-linux-x64/output/sqlite/lib -L/opt/bitnami/common/lib -ldl
LIBS=
DEFS=-DHAVE_CONFIG_H
